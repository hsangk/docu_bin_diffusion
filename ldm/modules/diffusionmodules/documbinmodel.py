...
class Downsample(nn.Module):    # Gated conv
    """
    ...
    def forward_(self, X):
        return checkpoint(self.forward, (X,), self.parameters(), True)
...
class Upsample(nn.Module):      # gated upsample

    def __init__(self, channels, scale_factor=4, **kwargs):
        """
